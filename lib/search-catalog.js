...
function searchQuery(fragment) {
  return chairQuery(fragment).replace(/query ChairCatalog\(\$after: String\) \{\s*collection\(handle: "chaises"\) \{\s*handle title description\s*products\(first: 50, after: \$after, sortKey: BEST_SELLING\)/,
